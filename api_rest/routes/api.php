...
// Rotas Usuarios
Route::get('/users', [UserController::class, 'index']); // GET all http://127.0.0.1:8000/api/users?page=1
...
// Rotas Clients
Route::get('/clientes', [ApiClienteController::class, 'index']); //GET all http://127.0.0.1:8000/api/clientes?page=1
...
// Rotas Pedidos
Route::get('/pedidos', [PedidoController::class, 'index']); //GET all http://127.0.0.1:8000/api/pedidos?page=1
